  ...
  return (
    <div className='prose prose-stone mx-5 my-12 flex max-w-7xl flex-col items-center md:flex-row lg:mx-auto'>
      <div className='mx-auto w-full max-w-[90%] md:mr-3 md:max-w-[46%]'>
        ...
        This project was developed by Prabyasachi Mohanty using React.js and Firebase, ensuring a seamless and efficient user experience with a modern frontend and a reliable backend.
        </p>
      </div>
